######### all of the following code were obtained from https://github.com/amitport/DRIVE-One-bit-Distributed-Mean-Estimation/blob/main/experiments/distributed/compression/rotated_compression.py ########
